...
def main():
    cantidades_muestras_compilados = range(1000)
    muestras_compilados = []
    for cantidad in cantidades_muestras_compilados:
        muestras_aux = []
        for _ in range(3):
            muestras_aux.append(generar_compilados_aleatorios(cantidad))
        muestras_compilados.append(muestras_aux)

    print(muestras_compilados)
